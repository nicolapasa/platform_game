...
loadSprite("box", 'Box/box_idle.png')
loadSprite("box1", 'Box/box_1.png')
loadSprite("box2", 'Box/box_2.png')
loadSprite("box3", 'Box/box_3.png')
loadSprite("box4", 'Box/box_4.png')
loadSprite("spikes", 'traps/spikes.png')
loadSprite("door", 'door/door.png')

loadSprite("lift", 'oggetti/lift.png')

loadSprite("cannon", 'cannons/cannon.png')
loadSprite("ball", 'cannons/ball.png')
...
loadSpriteAtlas("cannons/shoot.png", {
  "cannon_fire":
  {
    x: 0,
    y: 0,
...
loadSpriteAtlas("cannons/boom.png", {
  "boom":
  {
    x: 0,
    y: 0,
...
function add_borders(level) {
  ...
  switch (level) {
    case 0:
      ...
      camScaleLevel=1.8//setting specifico del livello
...
gravity=4000
  ...
  add([text('stage: ' + parseInt(level + 1) + ' score: '), fixed(true), pos(0, height()-30), scale(0.4)])
